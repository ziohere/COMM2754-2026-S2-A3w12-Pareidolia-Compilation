const myMainCanvasSketch = (p) => {
  ...
  // AUDIO ENGINE
  // =========================================================
  const blipSound = new Audio("../designed_sounds/COMM2754-2026-S2-A3w12-Pareidolia-blip-anim.wav");
  const ambientSound = new Audio("../designed_sounds/COMM2754-2026-S2-A3w12-Pareidolia-ambient.wav");
  const corruptionSound = new Audio("../designed_sounds/COMM2754-2026-S2-A3w12-Pareidolia-radiosilent-anim.wav");
  const transitionSoundPaths = [
     "../designed_sounds/COMM2754-2026-S2-A3w12-Pareidolia-airleak-1-anim.wav",
      "../designed_sounds/COMM2754-2026-S2-A3w12-Pareidolia-transit-1-anim.wav",
     "../designed_sounds/COMM2754-2026-S2-A3w12-Pareidolia-flashing.wav",
  ];
  const textNotificationSoundPaths = [
    "../designed_sounds/COMM2754-2026-S2-A3w12-Pareidolia-blip2-anim.wav",
  ];
  const corruptPopupSoundPaths = [
    "../designed_sounds/COMM2754-2026-S2-A3w12-Pareidolia-beat-anim.wav",
    "../designed_sounds/COMM2754-2026-S2-A3w12-Pareidolia-noise.wav",
    "../designed_sounds/COMM2754-2026-S2-A3w12-Pareidolia-low-airleak.wav",
  ];
